...
"""
    ...
    def test_block_to_block_types(self):
        ...
        block = "```\ncode\n```"
        self.assertEqual(block_to_type(block), block_type_code)
        block = "> quote\n> more quote"
        self.assertEqual(block_to_type(block), block_type_quote)
        block = "* list\n* items"
        self.assertEqual(block_to_type(block), block_type_ulist)
        block = "1. list\n2. items"
        self.assertEqual(block_to_type(block), block_type_olist)
        block = "paragraph"
